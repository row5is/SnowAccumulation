...
This was a live demo of how to create a console app from scratch using github copilot and the *plan* skill. Look at the [problemdescription.md](https://github.com/row5is/SnowAccumulation/blob/master/problemdescription.md) to see how we got started.
